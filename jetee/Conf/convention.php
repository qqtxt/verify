...
return  array(
    ...
    'DB_SQL_BUILD_QUEUE'    => 'file',   // SQL缓存队列的缓存方式 支持 file xcache和apc   队列暂不支持
    ...
    'TMPL_ACTION_ERROR'     => JETEE_PATH.'Tpl/dispatch_jump.tpl', // 默认错误跳转对应的模板文件
    'TMPL_ACTION_SUCCESS'   => JETEE_PATH.'Tpl/dispatch_jump.tpl', // 默认成功跳转对应的模板文件
    'TMPL_EXCEPTION_FILE'   => JETEE_PATH.'Tpl/think_exception.tpl',// 异常页面的模板文件
