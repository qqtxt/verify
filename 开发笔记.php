...
CREATE TABLE IF NOT EXISTS `je_privilege` (
	...
	`relevance`	varchar(20) NOT NULL DEFAULT ''						COMMENT '关联权限',
	`comment`	varchar(20) NOT NULL DEFAULT ''						COMMENT '说明',
	PRIMARY KEY (`pid`),
	KEY `parent_id` (`up_id`)
...
(NULL, 1, 'User_lists', '', '查看商家'),
(NULL, 1, 'User_del', '', '删除商家'),
(NULL, 1, 'User_edit', '', '编辑商家'),
(NULL, 1, 'Store_lists', '', '店铺管理'),
(NULL, 1, 'Store_del', '', '删除店铺'),
(NULL, 1, 'Store_edit', '', '编辑店铺'),
(NULL, 1, 'Task_lists', '', '任务管理'),
(NULL, 1, 'Task_del', '', '删除任务'),
(NULL, 1, 'Task_edit', '', '编辑任务'),
(NULL, 1, 'Recharge_lists', '', '查看充值'),
(NULL, 1, 'Recharge_add', '', '添加充值'),
(NULL, 1, 'Recharge_del', '', '删除充值'),
(NULL, 1, 'Recharge_edit', '', '编辑充值'),

(NULL, 2, 'Buyer_lists', '', '查看买手'),
(NULL, 2, 'Buyer_del', '', '删除买手'),
(NULL, 2, 'Buyer_edit', '', '编辑买手'),
(NULL, 2, 'Task_order_lists', '', '任务订单管理'),
(NULL, 2, 'Task_order_del', '', '删除订单'),
(NULL, 2, 'Task_order_edit', '', '编辑订单'),
(NULL, 2, 'Task_order_back', '', '订单返款'),
(NULL, 2, 'Cash_lists', '', '查看提现'),
(NULL, 2, 'Cash_add', '', '添加提现'),
(NULL, 2, 'Cash_del', '', '删除提现'),
(NULL, 2, 'Cash_edit', '', '编辑提现'),
(NULL, 2, 'Account_lists', '', '查看买号'),
(NULL, 2, 'Account_del', '', '删除买号'),
(NULL, 2, 'Account_edit', '', '编辑买号'),
(NULL, 2, 'View_order_lists', '', '浏览订单管理'),
(NULL, 2, 'View_order_del', '', '删除浏览订单'),
(NULL, 2, 'View_order_edit', '', '编辑浏览订单'),

(NULL, 3, 'Notice_lists', '', '查看公告'),
(NULL, 3, 'Notice_add', '', '添加公告'),
(NULL, 3, 'Notice_del', '', '删除公告'),
(NULL, 3, 'Notice_edit', '', '编辑公告'),
(NULL, 3,  'Notification_lists', '', '查看通知'),
(NULL, 3, 'Notification_del', '', '删除通知'),
(NULL, 3, 'Feedback_lists', '', '查看反馈'),
(NULL, 3, 'Feedback_add', '', '添加反馈'),
(NULL, 3, 'Feedback_del', '', '删除反馈'),
(NULL, 3, 'Feedback_edit', '', '编辑反馈'),
(NULL, 3, 'Event_lists', '', '查看事件'),
(NULL, 3, 'Event_del', '', '删除事件'),
(NULL, 3, 'Account_log_lists', '', '查看消费记录'),
(NULL, 3, 'Account_log_add', '', '添加消费记录'),
(NULL, 3, 'Appeal_lists', '', '查看申诉'),
(NULL, 3, 'Appeal_edit', '', '编辑申诉'),
(NULL, 3, 'Appeal_process_lists', '', '查看申诉进程'),
(NULL, 3, 'Appeal_process_add', '', '添加申诉进程'),

(NULL, 7, 'Article_lists', '', '查看文章'),
(NULL, 7, 'Article_add', '', '添加文章'),
(NULL, 7, 'Article_del', '', '删除文章'),
(NULL, 7, 'Article_edit', '', '编辑文章'),
(NULL, 7, 'Article_cat_lists', '', '查看分类'),
(NULL, 7, 'Article_cat_add', '', '添加分类'),
(NULL, 7, 'Article_cat_del', '', '删除分类'),
(NULL, 7, 'Article_cat_edit', '', '编辑分类'),

(NULL, 8, 'Admin_lists', '', '查看管理员'),
(NULL, 8, 'Admin_add', '', '添加管理员'),
(NULL, 8, 'Admin_del', '', '删除管理员'),
(NULL, 8, 'Admin_edit', '', '编辑管理员'),
(NULL, 8, 'Role_lists', '', '查看角色'),
(NULL, 8, 'Role_add', '', '添加角色'),
(NULL, 8, 'Role_del', '', '删除角色'),
(NULL, 8, 'Role_edit', '', '编辑角色'),
(NULL, 8, 'Admin_log_lists', '', '查看管理日志'),
(NULL, 8, 'Admin_log_del', '', '删除管理日志'),

(NULL, 9, 'Config_basic', '', '基本设置'),
(NULL, 9, 'Ad_lists', '', '查看广告'),
(NULL, 9, 'Ad_add', '', '添加广告'),
(NULL, 9, 'Ad_del', '', '删除广告'),
(NULL, 9, 'Ad_edit', '', '编辑广告'),
(NULL, 9, 'Region_lists', '', '查看地区'),
(NULL, 9, 'Region_add', '', '添加地区'),
(NULL, 9, 'Region_del', '', '删除地区'),
(NULL, 9, 'Region_edit', '', '编辑地区'),
(NULL, 9, 'Admin_clear_cache', '', '刷新缓冲');
