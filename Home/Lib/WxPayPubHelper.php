...
/*  	const APPID = 'wx3ce89798d2498644';
	const MCHID = '1449835802';
	const KEY ='1g8LDunbq0IjuX5uqKko0Tdb8GDvmmGb';
	const APPSECRET = 'e6a892e08ef02e403f1cb24f1ccbf080';
 */
	
	//=======【证书路径设置】=====================================
	//证书路径,注意应该填写绝对路径
	const SSLCERT_PATH = '/pay/apiclient_cert.pem';
	const SSLKEY_PATH = '/pay/apiclient_key.pem';
