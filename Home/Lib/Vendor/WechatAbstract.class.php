...
class WechatAbstract
{
	 ...
	 * 设置消息发送者
	 */
	public function setRevFrom($openid) {
		return $this->_receive['FromUserName']=$openid;
	}
...
<Nonce><![CDATA[%s]]></Nonce>
	...
	/**
	 * 通过code获取Access Token  简单获取openid
	...
	public function get_content($template_id,$arr){
		switch($template_id){
			//购买成功通知
			case 'qT9dXPq6oZPKzMTQHZ28pSUFe12QbAnIA6Scepit-bg':
				return  array(
					'touser'=>$arr[0],
					'template_id'=>'qT9dXPq6oZPKzMTQHZ28pSUFe12QbAnIA6Scepit-bg',
					'url'=>$arr[1],
					'topcolor'=>'#FF0000',
					'data'=>array(
			...
			break;
			//佣金提醒
			case 'YcIEUquANkvHcxhgV9lqKTTXqk8p_KBke6KcilyKy4E':
				return  array(
					'touser'=>$arr[0],
					'template_id'=>'YcIEUquANkvHcxhgV9lqKTTXqk8p_KBke6KcilyKy4E',
					'url'=>$arr[1],
					'topcolor'=>'#FF0000',
					'data'=>array(
						...
						'remark'  		=>array('value'=>$arr[5],'color'=>"#173177")
					)				
				);				
			break;
			//关注成功通知
			case '7CCA73mkJe91RS7S_Q0eLYrHdmUOKpjy3HvsbdqtFE8':
				return  array(
					'touser'=>$arr[0],
					'template_id'=>'7CCA73mkJe91RS7S_Q0eLYrHdmUOKpjy3HvsbdqtFE8',
					'url'=>$arr[1],
					'topcolor'=>'#FF0000',
					'data'=>array(
						'first'   		=>array('value'=>$arr[2],'color'=>"#173177"),
